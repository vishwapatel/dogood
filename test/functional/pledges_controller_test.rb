...
class PledgesControllerTest < ActionController::TestCase
  ...
  test "should create pledge" do
    assert_difference('Pledge.count') do
      post :create, pledge: { pledge_description: @pledge.pledge_description, pledge_title: @pledge.pledge_title }
    end
  ...
  test "should update pledge" do
    put :update, id: @pledge, pledge: { pledge_description: @pledge.pledge_description, pledge_title: @pledge.pledge_title }
    assert_redirected_to pledge_path(assigns(:pledge))
  end
